...
public class SearchTests extends BaseTest {
    ...
    public void navigateToLoginPage() {
        try {
            page.navigate("https://www.flipkart.com", new Page.NavigateOptions().setWaitUntil(WaitUntilState.LOAD));

            page.waitForURL(url -> url.contains("flipkart.com"), new Page.WaitForURLOptions().setTimeout(45000));
